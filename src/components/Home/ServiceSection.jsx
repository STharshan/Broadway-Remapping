...
const services = [
  ...
  {
    title: "Vehicles Damaged",
   // desc: `Headlight restoration is the process of removing haze and discolouration from headlights to improve visibility and the overall appearance of a vehicle`,
    image: "/gray.avif",
    path: "/services/service",
  },
  {
    title: "Air Conditioning Evac",
    //desc: `Turn your grey faded plastics and transform them back into black plastic trims they once were`,
    image: "/carmechanic.avif",
    path: "/services/mot",
  },
  {
    title: "Computer Diagnostics",
    //desc: `Full clay bar and compound is a detailing process that involves using a clay bar and compound to remove contaminants and imperfections from a vehicle's exterior surfaces`,
    image: "/paint.webp",
    path: "/services/wheel-alignment",
  },
    {
    title: "Performance Upgrades",
    //desc: `Machine polishing involves using a machine polisher and a special abrasive compound to remove scratches, swirl marks, and other imperfections from a vehicle's paintwork`,
    image: "/paint.webp",
    path: "/services/wheel-alignment",
  }
              ...
              >
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.src = "/image.png"; // fallback logo
                  }}
                />
